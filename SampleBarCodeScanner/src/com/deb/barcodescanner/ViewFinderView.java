 ...
 * 
 * @author Debasish
 * Custom View for scanner Activity
 */
public class ViewFinderView extends View {
    ...
    public static int FRAME_HEIGHT = 1920;
    public static int FRAME_TOP = 0;
    ...
    public synchronized void updateFramingRect() {
		...
		/**
		 * Code for scanning only on Laser line
		 */
		int middle = mFramingRect.height() / 2 + mFramingRect.top;
		FRAME_WIDTH  = mFramingRect.width();
		FRAME_HEIGHT = 2;
		FRAME_TOP    = middle - 1;
		FRAME_LEFT   = mFramingRect.left;

		/**
		 * Code for scanning only on Preview Frame
		 */
		/*
		 * FRAME_WIDTH = mFramingRect.width();
		 * FRAME_HEIGHT= mFramingRect.height();
		 * FRAME_TOP   = mFramingRect.top;
		 * FRAME_LEFT  = mFramingRect.left;
		 */
